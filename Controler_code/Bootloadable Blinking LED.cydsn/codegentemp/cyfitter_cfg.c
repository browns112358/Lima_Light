...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_CLK_DIVIDER_B00), 0x80000BB7u);

	/* CYDEV_CLK_DIVIDER_C00 Starting address: CYDEV_CLK_DIVIDER_C00 */
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_CLK_DIVIDER_C00), 0x80000BB7u);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_HSIOM_PORT_SEL1), 0x33030000u);
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_HSIOM_PORT_SEL2), 0x00003030u);
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT1_PC), 0x00D86000u);

		/* IOPINS0_2 Starting address: CYDEV_PRT2_DR */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT2_DR), 0x0000000Au);
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_PRT2_PC), 0x00000C30u);
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_UDB_PA2_CFG8), 0x00840000u);
