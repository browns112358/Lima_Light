...
#define Yellow_DM_ALG_HIZ         (0x00u << Yellow_DRIVE_MODE_SHIFT)
#define Yellow_DM_DIG_HIZ         (0x01u << Yellow_DRIVE_MODE_SHIFT)
#define Yellow_DM_RES_UP          (0x02u << Yellow_DRIVE_MODE_SHIFT)
#define Yellow_DM_RES_DWN         (0x03u << Yellow_DRIVE_MODE_SHIFT)
#define Yellow_DM_OD_LO           (0x04u << Yellow_DRIVE_MODE_SHIFT)
#define Yellow_DM_OD_HI           (0x05u << Yellow_DRIVE_MODE_SHIFT)
#define Yellow_DM_STRONG          (0x06u << Yellow_DRIVE_MODE_SHIFT)
#define Yellow_DM_RES_UPDWN       (0x07u << Yellow_DRIVE_MODE_SHIFT)
