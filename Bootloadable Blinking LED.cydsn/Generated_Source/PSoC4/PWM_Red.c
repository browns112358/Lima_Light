...
void PWM_Red_Init(void) 
{
        ...
        ctrl = PWM_Red_CONTROL & ((uint8)(~PWM_Red_CTRL_CMPMODE2_MASK)) & ((uint8)(~PWM_Red_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void PWM_Red_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        PWM_Red_CONTROL &= ((uint8)(~(PWM_Red_CTRL_CMPMODE1_MASK | PWM_Red_CTRL_CMPMODE2_MASK))); 
...
void PWM_Red_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    uint8 PWM_Red_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(PWM_Red_STATUS_PTR);
    	return (result);
    }
